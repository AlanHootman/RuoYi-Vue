...
public class NewsController extends BaseController
{
    ...
    @Log(title = "新闻模块", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "新闻模块", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "新闻模块", businessType = BusinessType.DELETE)
	@DeleteMapping("/{ids}")
